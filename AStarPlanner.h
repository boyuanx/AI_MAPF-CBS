...
private:
    ...
    bool satisfiesConstraint(int agent_id, const AStarNode *node, const list<Constraint> &constraints) const;
    int getLargestConstraintTimestep(int agent_id, int goal_location, const list<Constraint>& constraints) const;
    void clear();
};
